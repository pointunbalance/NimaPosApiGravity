...
export const GarageStaff = () => {
  const rolesList = ["مدير ورشة","مهندس ميكانيكا","مهندس كهرباء","فني فحص","سمكري","مساعد فني","عامل غسيل"];
  ...
  const staff = useLiveQuery(() => 
    db.users.filter(u => u.department === 'garage').toArray()
  ) || [];
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">إدارة موظفي الورشة</h1>
          <p className="text-slate-500">سجل وحسابات رواتب وأداء طاقم الورشة</p>
        </div>
        <button 
