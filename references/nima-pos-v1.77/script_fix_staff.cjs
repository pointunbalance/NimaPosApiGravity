...
let a = fs.readFileSync('pages/school/SchoolStaff.tsx', 'utf8');
...
`</form>
            ...
            {isTransModalOpen && selectedStaff && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm overflow-y-auto">`);
...
fs.writeFileSync('pages/school/SchoolStaff.tsx', a);
console.log('Fixed SchoolStaff');
