...
export const SchoolStaffTransModal = (props: any) => {
const { transModalOpen, setTransModalOpen, transFormData, setTransFormData, staff, handleSaveTrans, isReportOpen, setIsReportOpen, reportTripId, trips } = props;
